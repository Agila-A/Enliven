...
import loginImg from "../../utils/assets/login.png"; 
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row font-sans">
      ...
      <div className="flex-1 bg-cream flex items-center justify-center p-8 md:p-12 relative overflow-hidden">
        ...
        <div className="absolute top-10 left-10 w-32 h-32 bg-yellow/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-10 right-10 w-40 h-40 bg-green/20 rounded-full blur-3xl"></div>
      ...
      {/* RIGHT PANEL */}
      <div className="hidden md:flex flex-1 bg-green items-center justify-center p-12 relative overflow-hidden">
        {/* Abstract circles */}
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] bg-cream/20 rounded-full blur-3xl mix-blend-overlay"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-yellow/20 rounded-full blur-3xl mix-blend-overlay"></div>

        <div className="text-center text-cream relative z-10 flex flex-col items-center">
          <div className="bg-cream/10 p-6 rounded-3xl backdrop-blur-sm border border-cream/20 mb-8 inline-block shadow-soft">
            <h1 className="text-4xl font-semibold mb-2">Learn with</h1>
            <h1 className="text-6xl font-bold tracking-tight text-white drop-shadow-md">
              Enliven
            </h1>
          </div>
          
          <p className="text-lg text-cream/90 max-w-md mx-auto mb-10 font-medium whitespace-pre-line">
            Personalized learning paths tailored exactly to your strengths.
          </p>
